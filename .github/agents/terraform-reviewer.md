...
description: Terraform-focused agent that reviews and creates safer Terraform changes with emphasis on state safety, least privilege, module patterns, drift detection, and plan/apply discipline. Use for Terraform code review, plan analysis, and best practice enforcement.
