---
description: Comprehensive secure coding instructions for all languages and frameworks, based on OWASP Top 10 and industry best practices. Use for secure code generation, review, and refactoring across the codebase.
applyTo: '*'
---
