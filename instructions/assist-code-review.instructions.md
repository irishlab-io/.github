---
description: Generic code review instructions that can be customized for any project using GitHub Copilot. These instructions cover code quality, security, testing, performance, architecture, and documentation review principles and best practices.
applyTo: '**'
excludeAgent:
  - "coding-agent"
---
