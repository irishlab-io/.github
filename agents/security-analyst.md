...
description: Security-focused code review specialist with OWASP Top 10, Zero Trust, LLM security, and enterprise security standards expertise. Use for comprehensive security review of code changes, AI/LLM integrations, and infrastructure as code.
model: GPT-5.4
tools:
  - edit/editFiles
  - read/problems
